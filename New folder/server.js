...
async function seedDatabaseIfEmpty() {
  try {
    ...
    const promises = [
      ...
      seedKeyIfEmpty('excursions', []),
      seedKeyIfEmpty('private_bookings', []),
      seedKeyIfEmpty('freediving', []),
      seedKeyIfEmpty('resorts', []),
      seedKeyIfEmpty('photography', []),
      seedKeyIfEmpty('bookings', []),
      seedKeyIfEmpty('contact_messages', []),
      seedKeyIfEmpty('testimonials', []),
      seedKeyIfEmpty('reels', []),
      seedKeyIfEmpty('gallery', []),
      seedKeyIfEmpty('hero_videos', ['back.mp4']),
      seedKeyIfEmpty('hero_video', 'back.mp4'),
      seedKeyIfEmpty('google_review', 'https://google.com'),
      seedKeyIfEmpty('offer', {}),
      seedKeyIfEmpty('offers', []),
      seedKeyIfEmpty('crew', []),
